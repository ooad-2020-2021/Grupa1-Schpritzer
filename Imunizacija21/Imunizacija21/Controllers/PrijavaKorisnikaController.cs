...
namespace Imunizacija21.Controllers
{
    public class PrijavaKorisnikaController : Controller
    {
        ...
        public PrijavaKorisnikaController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Adresa,Zanimanje,ID,DatumRodjenja,Email")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Adresa,Zanimanje,ID,DatumRodjenja,Email")] Korisnik korisnik)
        {
            if (id != korisnik.ID)
            {
                return NotFound();
